...
public class ThuocTinhSanPham {
    ...
    /*public ThuocTinhSanPham(int maTT, String maSP, String boNho, String RAM, String chipSet, String heDieuHanh, String manHinh, String dungLuongPin, String congSac, String loaiPhuKien) {
        this.maTT = maTT;
        this.maSP = maSP;
        this.boNho = boNho;
        this.RAM = RAM;
