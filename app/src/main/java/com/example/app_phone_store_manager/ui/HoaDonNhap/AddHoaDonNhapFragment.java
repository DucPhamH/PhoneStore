package com.example.app_phone_store_manager.ui.HoaDonNhap;
...
import com.example.app_phone_store_manager.adapter.ChonSPAdapter;
import com.example.app_phone_store_manager.dao.DaoCTHD;
import com.example.app_phone_store_manager.dao.DaoHD;
        ...
        adapter.setItemSanPhamClick(new ItemSanPhamClick() {
            ...
            public void ItemClick(SanPham sanPham) {
                if (edSanPham.length() == 0) {
                    ...
                    Toast.makeText(appCompatActivity, "Chọn sản phẩm thành công", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                } else {
                    tenSP = sanPham.getTenSP();
                    maSP = sanPham.getMaSP();
