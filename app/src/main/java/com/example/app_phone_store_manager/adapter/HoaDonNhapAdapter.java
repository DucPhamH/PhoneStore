...
public class HoaDonNhapAdapter extends RecyclerView.Adapter<HoaDonNhapAdapter.ViewHolder> implements Filterable {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                String serHDN = constraint.toString();
                if (serHDN.isEmpty()) {
                    list = mListHDNold;
                } else {
                    List<HoaDon> listHDN = new ArrayList<>();
                    for (HoaDon hoaDonNhap : mListHDNold) {
                        if (hoaDonNhap.getMaHD().toLowerCase().contains(serHDN.toLowerCase()) ||
                                hoaDonNhap.getNgay().toLowerCase().contains(serHDN.toLowerCase())) {
                            listHDN.add(hoaDonNhap);
                        }
                    }
                    list = listHDN;
                }
